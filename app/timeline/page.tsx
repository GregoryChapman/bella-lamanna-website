...
const timelineSections = [
  ...
  },
  {
    ...
    images: [
      ...
      "/images/timeline/growth45.jpg",
      "/images/timeline/growth48.jpg",
      "/images/timeline/growth59.jpg",
      "/images/timeline/growth72.jpg",
    ],
  },
  {
    era: "Summer 2025",
...
const reallyAboutSection = {
  ...
  images: [
    "/images/timeline/reallyabout18.jpg",
    "/images/timeline/reallyabout19.jpg",
    "/images/timeline/reallyabout22.jpg",
    "/images/timeline/reallyabout41.jpg",
    "/images/timeline/reallyabout43.jpg",
    "/images/timeline/reallyabout56.jpg",
  ],
};
    ...
    >
      {images.map((src, i) => (
        <motion.button
          ...
          className="group relative aspect-[3/4] rounded-2xl overflow-hidden shadow-sm bg-pink-50 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:ring-offset-1"
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <span className="w-9 h-9 bg-white/80 backdrop-blur-sm rounded-full flex items-center justify-center shadow-sm text-pink-600 text-lg">
              ⤢
            </span>
          </div>
        </motion.button>
...
function SectionCard({
  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 shadow-sm hover:border-pink-100 hover:shadow-md transition-all duration-300 p-6 sm:p-8">
      <span className="inline-block px-3 py-1 bg-pink-50 text-pink-600 text-xs font-semibold rounded-full border border-pink-100 mb-3">
        {section.era}
      </span>
      <h3 className="font-outfit text-xl sm:text-2xl font-bold text-gray-900 mb-3">
        {section.title}
      </h3>
      <div className="w-8 h-0.5 bg-pink-200 rounded-full mb-4" />
...
export default function TimelinePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-500 leading-relaxed max-w-xl mx-auto">
              My journey as a content creator and the milestones along the way.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* ── Page Intro ──────────────────────────────────────────────────── */}
      <section className="bg-gradient-to-b from-pink-50/40 to-white pt-10 pb-20 px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <h2 className="font-outfit text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
            My Story So Far
          </h2>
          <div className="w-10 h-0.5 bg-pink-300 rounded-full mx-auto mb-5" />
          <p className="text-base sm:text-lg text-gray-500 leading-relaxed">
            This timeline shares my journey from posting just for fun to building a platform
            focused on connection, kindness, and living life to the fullest. Every stage shaped
            who I am today, both online and offline.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="relative">
            ...
            {/* Center line */}
            <div className="absolute top-0 bottom-0 w-px bg-gradient-to-b from-pink-200 via-rose-300 to-pink-200 left-5 lg:left-1/2 lg:-translate-x-px" />

            <div className="space-y-16">
              {timelineSections.map((section, i) => {
                const isLeft = i % 2 === 0;
                const animDelay = i * 0.06;
                const handleClick = (index: number) => openModal(section.images, index);
                  ...
                  >
                    ...
                    <div className="relative flex justify-center pt-8 lg:pt-9">
                      <motion.div
                        ...
                        className="relative z-10 w-5 h-5 rounded-full bg-white border-[3px] border-pink-400 shadow-sm shadow-pink-200 shrink-0"
                      >
            ...
            >
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-pink-400 to-rose-500 flex items-center justify-center shadow-md shadow-pink-200 z-10">
      ...
      <section className="bg-pink-50/40 py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeUp()} className="mb-10">
            <span className="inline-block px-3 py-1 bg-white text-pink-600 text-xs font-semibold rounded-full border border-pink-100 mb-4">
              Always
            </span>
            <h2 className="font-outfit text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              {beyondSection.title}
            </h2>
            <div className="w-10 h-0.5 bg-pink-300 rounded-full mb-6" />
            <div className="space-y-5">
              {beyondSection.paragraphs.map((para, i) => (
          ...
          <ImageGrid
            images={beyondSection.images}
            animDelay={0.1}
            onImageClick={(index) => openModal(beyondSection.images, index)}
          />
        </div>
      </section>
      ...
      <section className="bg-white py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeUp()} className="mb-10">
            <span className="inline-block px-3 py-1 bg-pink-50 text-pink-600 text-xs font-semibold rounded-full border border-pink-100 mb-4">
              Always
            </span>
            <h2 className="font-outfit text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
          ...
          <ImageGrid
            ...
            animDelay={0.1}
            onImageClick={(index) => openModal(reallyAboutSection.images, index)}
          />
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-pink-400 via-rose-400 to-pink-500 py-24 px-4 sm:px-6 lg:px-8">
        <motion.div {...fadeUp()} className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/work-with-me"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-pink-600 font-semibold rounded-2xl shadow-lg hover:shadow-xl hover:bg-pink-50 transition-all transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-pink-500"
            >
              Work With Me
